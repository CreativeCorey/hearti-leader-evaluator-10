...
export const getDimensionReportContent = (
  ...
  const contentStructure: Record<HEARTIDimension, {
    strength: string;
    ...
    inclusivity: {
      strength: `<p><strong>Congratulations!</strong> ${userName}, your HEARTI:Leader strength is Inclusivity. You are a champion for differences. Inclusive leaders understand that diverse teams drive more significant innovation and better results.</p>`,
      vulnerability: `<p>${userName}, an area of growth for you is Inclusivity. Inclusive leaders are champions for differences, understanding that diverse teams drive more significant innovation and better results.</p>`,
      neutral: `<p>Inclusive leaders are champions for differences, understanding that diverse teams drive more significant innovation and better results.</p>`,
      description: `<p>Being an inclusive leader is about understanding the dynamics associated with belonging, hearing all voices, considering all ideas, and granting recognition to anyone deserving.</p>
      ...
      <p>HEARTI leaders are champions of inclusivity because it's better for the business. They are diversity and inclusion advocates driving change in the culture and systems within their organizations—and throughout the world.</p>`,
      levels: `<p><strong>Best in Class:</strong> Champions of belonging advocate to create a workplace where diversity, equity, and inclusion are foundational and supported by systems, processes, and culture, including individual and team accountability.</p>
      <p><strong>Evolving:</strong> Evolving leaders are aware that diversity, equity, and inclusion are essential—but lack advocacy and individual and team accountability.</p>
      <p><strong>Unready:</strong> Unready leaders are scarcity-driven. They may recognize that unconscious bias exists; however, they lack advocacy and basic systems, processes, and culture that track progress.</p>`,
      tips: `<ul>
        <li>Read Jennifer Brown's book, <em>How to Be An Inclusive Leader: Your Role in Creating Cultures of Belonging Where Everyone Can Thrive.</em></li>
        ...
        <li>Read <em>Good Guys: How Men Can Be Better Allies for Women in the Workplace</em>, by Professors David Smith and Brad Johnson.</li>
      </ul>`
    },
    humility: {
      strength: `<p><strong>Congratulations!</strong> ${userName}, your HEARTI:Leader strength is Humility. You are aware of your weaknesses, eager to improve yourself, appreciative of others' strengths, and focused on goals beyond your own self-interest.</p>`,
      vulnerability: `<p>${userName}, an area of growth for you is Humility. Humble leaders are aware of their weaknesses, eager to improve themselves, appreciative of others' strengths, and are focused on goals beyond their own self-interest.</p>`,
      neutral: `<p>Humble leaders are aware of their weaknesses, eager to improve themselves, appreciative of others' strengths, and are focused on goals beyond their own self-interest.</p>`,
      ...
      <p><strong>4 Core Elements to Being a Humble Leader</strong></p>
      <ul>
      ...
      levels: `<p><strong>Best-In-Class:</strong> Humble leaders focus on all stakeholders' needs, asking, "What have I done for others?"</p>
      <p><strong>Evolving:</strong> Individuals evolving their humble leadership prioritize the company's needs but may not understand the link to stakeholders. They may ask themselves, "What have I done for the organization?"</p>
      <p><strong>Unready:</strong> Leaders who are unready in humility are self- and personal career-minded, asking, "What have I done for me?"</p>`,
      tips: `<p>Being a humble leader requires overcoming a belief in scarcity and replacing it with a growth mindset. To become more familiar with a growth mindset, read Stanford University Professor Carol Dweck's book, <em>Mindset: The New Psychology of Success</em>, or you can watch her TEDTalk.</p>
      <p>Put Dweck's work into practice by adding the word "yet" to every negative statement. For example:</p>
      <ul>
      ...
      <p>If you struggle with micro-managing and perfectionism, enlist your colleagues and/or manager to help identify when you are being overly perfectionistic. Develop a code word or some way to lightly acknowledge the behaviors so you can better recognize patterns and can collaborate to change them.</p>
    ...
    empathy: {
      strength: `<p><strong>Congratulations!</strong> ${userName}, your HEARTI:Leader strength is Empathy. You can understand the feelings, needs, and motivations of others. Grounded in curiosity and learning, you also tend to be good at active listening and enjoy helping others grow and develop.</p>`,
      vulnerability: `<p>${userName}, an area of growth for you is Empathy. Empathetic leaders can understand the feelings, needs, and motivations of others. Grounded in curiosity and learning, you also tend to be good at active listening and enjoy helping others grow and develop.</p>`,
      neutral: `<p>Empathetic leaders can understand the feelings, needs, and motivations of others. Grounded in curiosity and learning, you also tend to be good at active listening and enjoy helping others grow and develop.</p>`,
      description: `<p>At its core, empathy is about truly understanding the needs of others. Understanding your own needs and feelings is a required prerequisite to understanding others. There are three types of empathy: cognitive, emotional, and compassionate. Understanding these can help you to build your skills as an empathetic leader.</p>
      <ul>
      ...
      <p>Empathy is also about a leader's ability to build and maintain rapport with others effectively. Utilizing compassionate empathy, a leader helps others' ability to take steps forward without getting consumed by others' emotions or taking inappropriate 'rescuing' actions.</p>`,
      levels: `<p><strong>Best-in-Class:</strong> Best-in-class empathetic leaders are accountable for effectively connecting with others. They are in tune with their own emotions and able to communicate with others on an emotional level. They employ measurement tools to gain feedback to understand better their ability to listen to and develop followers.</p>
      <p><strong>Evolving:</strong> Individuals developing their empathy recognize it as valuable but may not truly understand how to connect with others authentically—sometimes, they will demonstrate rescue behaviors instead. They are not likely to ask for feedback or employ performance measures.</p>
      <p><strong>Unready:</strong> Leaders who are unready in empathy do not recognize the value of empathic behaviors.</p>`,
      tips: `<p>Leadership expert Andrew Sobel has outlined eight ways you can increase your empathy. Here are a few you can try this week:</p>
      <ul>
    ...
    accountability: {
      ...
      neutral: `<p>Accountable leaders dare to make unpopular decisions and the willingness to hold themselves and others accountable for their actions and decisions. They communicate what they will do, collaborate with others to get buy-in and deliver as promised. They often operate with the code of "Leader's Intent"—which simply means they set clear goals and are flexible on the path.</p>`,
      description: `<p>Accountable leaders succeed because they build trust with stakeholders, including employees, colleagues, co-workers, customers, and their community.</p>`,
      levels: `<p><strong>Best-In-Class:</strong> Best-in-class accountable leaders utilize tools such as strategic plans and cascading goals that outline individual and team accountability. They also take the opportunity to check in regularly with followers.</p>
      <p><strong>Evolving:</strong> Individuals evolving their accountable leadership may work with individuals and their team to clearly define role clarity and organizational objectives but may not be consistent in holding individuals and/or the team accountable.</p>
      <p><strong>Unready:</strong> Leaders who are unready in accountability are focused on the individual. They may lack understanding of cross-team interdependence, have unclear objectives and measurements, and practice inconsistent decision-making.</p>`,
      tips: `<p>Trust builds accountability. In her book <em>Braving the Wilderness</em>, Brené Brown explains that trust is composed of seven key elements:</p>
      <ul>
        <li><strong>B: Boundaries</strong>—you're clear on what is ok and what is not ok</li>
        <li><strong>R: Reliability</strong>—you do what you say you are going to do</li>
        <li><strong>A: Accountability</strong>—you own your mistakes</li>
        <li><strong>V: Vault</strong>—you don't share information or experiences that aren't yours to share</li>
        <li><strong>I: Integrity</strong>—you practice your values rather than just profess them</li>
        <li><strong>N: Non-judgmental</strong>—you are confident enough to ask for what you need and allow others to do the same</li>
        <li><strong>G: Generosity</strong>—you are generous of spirit and assume positive intent</li>
      </ul>
      <p>Consider how you are holding yourself accountable and start BRAVING to lead. Then, start measuring what matters. Accountability is foundational to business; we set goals and keep our teams accountable to those goals. As Andy Grove, past CEO of Intel, once said, "What gets measured, gets done."</p>
    ...
    resiliency: {
      ...
      neutral: `<p>Resilient leaders can persevere and respond with agility when faced with challenges, and they inspire others to continue towards a common purpose. They are strategic and can leapfrog competition through an agile response to challenges. They also understand that perseverance may not always be the answer—they know when to stop and are willing to pivot.</p>`,
      description: `<p>In his TED Talk on resilient leadership, clinical psychologist Raphael Rose details the core attributes of resilient leaders. They are:</p>
      <ul>
      ...
      <p>Resilient leaders are realistic optimists who don't let the shiny new object distract them and can plot a course for practical and aspirational success. They are driven by more than personal gain and can use their fundamental belief in purpose to create a context for today's challenges.</p>
      <p>Having leaders with resilience who can navigate during times of uncertainty is critical. The Covid-19 pandemic tested companies in more ways than one, and those with resilient teams managed to pivot and find new ways to lead amid the chaos. This agility is core to resilience.</p>`,
      levels: `<p><strong>Best-In-Class:</strong> Best-in-class resilient leaders cultivate and value resiliency in their followers and teams. They hire for this skill and nurture resilience by rewarding teams, not just individuals, for innovative thinking and failure.</p>
      <p><strong>Evolving:</strong> Individuals developing their resilient leadership recognize the need for resilience but may not have performance measures and processes to capture learnings.</p>
      <p><strong>Unready:</strong> Leaders who are unready in resilience may punish individuals for team shortcomings. They may lack team rewards and processes to capture learnings from successes and failures.</p>`,
      tips: `<ul>
  ...
  // Return the appropriate content based on status
  return {
    statusContent: contentStructure[dimension][status],
    description: contentStructure[dimension].description,
    levels: contentStructure[dimension].levels,
    tips: contentStructure[dimension].tips
  };
};
